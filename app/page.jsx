        ...
        <Section>
          <Contentbox className="content-box--headfull bg-light-400">
              ...
              <div className="grid-cols grid-cols--2 ">
                    <Contentbox2Cols 
                      className="bg-light-300 gap-block__end--20 full-height"
                    ...
                    <ContentboxGrid className="content-box--grid">
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                        <ContentboxLineLeft className="content-box content-box--line-left text-second-green">
                      ...
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                        <ContentboxLineLeft className="content-box content-box--line-left text-second-cyan">
                      ...
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                        <ContentboxLineLeft className="content-box content-box--line-left text-third-magenta">
                      ...
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                      {/* Box with Line at the left side the classname text-... change the color of the line */}
                        <ContentboxLineLeft className="content-box content-box--line-left text-second-yellow">
          ...
          <div className="content-box bg-light-400">
            ...
            <div className="content-box__header content-box--line-left--rounded text-second-green bg-light-300">
              ...
              <div className="data text-dark-100 text__bold">
                <span className="text">
                  <TotalAmount db={dataTrs} category="Bills" />
                </span>
              </div>
            </div>
            {/*  Box width rounded line at left side */}
